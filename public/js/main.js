(function e(t, n, r) {
...
})(
  {
    1: [
      function (require, module, exports) {
        ...
        Microphone.prototype.onMediaStream = function (stream) {
          ...
          console.log(
            "Microphone.onMediaStream(): sampling rate is:",
            this.sampleRate
          );
         ...
         */
        Microphone.prototype._exportDataBufferTo16Khz = function (
          bufferNewSamples
        ) {
          var buffer = null,
          ...
          var filter = [
            ...
            nOutputSamples =
              Math.floor((buffer.length - filter.length) / samplingRateRatio) +
              1,
          ...
          if (remaining > 0) {
            ...
            for (i = 0; i < remaining; ++i) {
              this.bufferUnusedSamples[i] =
                buffer[indexSampleAfterLastUsed + i];
            }
          } else {
            this.bufferUnusedSamples = new Float32Array(0);
          }
      ...
      function (require, module, exports) {
        module.exports = {
          models: [
            {
              url:
                "https://stream.watsonplatform.net/speech-to-text/api/v1/models/ar-AR_BroadbandModel",
              rate: 16000,
            ...
            {
              url:
                "https://stream.watsonplatform.net/speech-to-text/api/v1/models/pt-BR_BroadbandModel",
              rate: 16000,
            ...
            {
              url:
                "https://stream.watsonplatform.net/speech-to-text/api/v1/models/es-ES_BroadbandModel",
              rate: 16000,
            ...
            {
              url:
                "https://stream.watsonplatform.net/speech-to-text/api/v1/models/ja-JP_BroadbandModel",
              rate: 16000,
    ...
    3: [
      function (require, module, exports) {
        ...
        exports.handleFileUpload = function (
          token,
          model,
          file,
          contentType,
    ...
    4: [
      function (require, module, exports) {
        ...
        exports.handleMicrophone = function (token, model, mic, callback) {
          if (model.indexOf("Narrowband") > -1) {
            var err = new Error(
              "Microphone transcription cannot accomodate narrowband models, please select another"
            );
            callback(err, null);
            return false;
          }
      ...
      { "./socket": 6, "./views/displaymetadata": 9 },
    ],
    5: [
      function (require, module, exports) {
        /**
    ...
    6: [
      function (require, module, exports) {
        ...
        var initSocket = (exports.initSocket = function (
          options,
          onopen,
          onlistening,
          onmessage,
          ...
          var sessionPermissions = withDefault(
            options.sessionPermissions,
          ...
          socket.onclose = function (evt) {
            ...
            if (evt.code === 1006) {
              ...
              if (tokenGenerator.getCount() > 1) {
                $.publish("hardsocketstop");
                throw new Error(
                  "No authorization token is currently available"
                );
              }
      ...
      { "./Microphone": 1, "./utils": 7, "./views/showerror": 18 },
    ],
    7: [
      function (require, module, exports) {
        (function (global) {
      ...
      function (require, module, exports) {
        (function (global) {
          ...
          var showTimestamp = function (timestamps, confidences) {
            ...
            var displayConfidence = confidences
              ? confidences[1].toString().substring(0, 3)
              : "n/a";
            ...
            this.showAlternatives = function (alternatives, isFinal, testing) {
              ...
              alternatives.forEach(function (alternative, idx) {
                ...
                if (alternative.transcript) {
                  var transcript = alternative.transcript.replace(
                    /%HESITATION\s/g,
                    ""
                  );
          ...
          function getVoice() {
            ...
            var voice = "";
            if (mt_target == "en") voice = "en-US_MichaelVoice";
            // TODO: try 'en-US_AllisonVoice' or 'en-US_LisaVoice'
            else if (mt_target == "fr") voice = "fr-FR_ReneeVoice";
            else if (mt_target == "es") voice = "es-US_SofiaVoice";
            // TODO: try 'es-ES_EnriqueVoice' or 'es-ES_LauraVoice'
            else if (mt_target == "pt") voice = "pt-BR_IsabelaVoice";
          ...
          function getTargetLanguageCode() {
            ...
            if (lang == "English") mt_target = "en";
            else if (lang == "French") mt_target = "fr";
            else if (lang == "Spanish") mt_target = "es";
            else if (lang == "Portuguese") mt_target = "pt";
          ...
          function translate(textContent) {
            ...
            var currentModel =
              localStorage.getItem("currentModel") || "en-US_BroadbandModel";
            ...
            if (mt_source != mt_target) {
              ...
              $.ajax(restAPICall)
                .done(function (data) {
                  var translation =
                    data.result["translations"][0]["translation"];
  ...
  */
          ...
          var playTTSChunk = async () => {
            if (ttsChunksIndex >= ttsChunks.length) return;
          ...
          function playTTSifInputSpeechIsOff() {
            ...
            if (
              (streaming == false && inputSpeechOn == true) ||
          ...
          exports.showResult = function (msg, baseString, callback) {
            ...
            if (msg.results && msg.results.length > 0) {
              ...
              if (msg.results && msg.results[0] && msg.results[0].final) {
                ...
                displayFinalString = displayFinalString.replace(
                  /%HESITATION\s/g,
                  ""
                );
                displayFinalString = displayFinalString.replace(
                ...
                if (res == null) {
                  ...
                  console.log(
                    "---> translation step is skipped for text=" + text
                  );
                }
              } else {
    ...
    11: [
      function (require, module, exports) {
        exports.flashSVG = function (el) {
          el.css({ fill: "#A53725" });
          function loop() {
            el.animate({ fill: "#A53725" }, 1000, "linear").animate(
              { fill: "white" },
              1000,
              "linear"
            );
      ...
      function (require, module, exports) {
        ...
        var handleSelectedFile = (exports.handleSelectedFile = (function () {
          ...
          return function (token, file) {
            var currentlyDisplaying = JSON.parse(
              localStorage.getItem("currentlyDisplaying")
            );
            ...
            r.onload = function () {
              ...
              if (r.result === "fLaC") {
                ...
                showNotice(
                  "Notice: browsers do not support playing FLAC audio, so no audio will accompany the transcription"
                );
                ...
                restoreUploadTab();
                showError(
                  "Only WAV or FLAC files can be transcribed, please try another file format"
                );
                return;
              }
              handleFileUpload(
    ...
    13: [
      function (require, module, exports) {
        var initSessionPermissions = require("./sessionpermissions")
        ...
        var initDisplayMetadata = require("./displaymetadata")
          .initDisplayMetadata;
      ...
      function (require, module, exports) {
        ...
        var LOOKUP_TABLE = {
          "ar-AR_BroadbandModel": [
            "ar-AR_Broadband_sample1.wav",
            "ar-AR_Broadband_sample2.wav",
          ],
          "en-US_BroadbandModel": [
            "Us_English_Broadband_Sample_1.wav",
            "Us_English_Broadband_Sample_2.wav",
          ],
          "en-US_NarrowbandModel": [
            "Us_English_Narrowband_Sample_1.wav",
            "Us_English_Narrowband_Sample_2.wav",
          ],
          "es-ES_BroadbandModel": [
            "Es_ES_spk24_16khz.wav",
            "Es_ES_spk19_16khz.wav",
          ],
          "es-ES_NarrowbandModel": [
            "Es_ES_spk24_8khz.wav",
            "Es_ES_spk19_8khz.wav",
          ],
          "ja-JP_BroadbandModel": [
            "sample-Ja_JP-wide1.wav",
            "sample-Ja_JP-wide2.wav",
          ],
          "ja-JP_NarrowbandModel": [
            "sample-Ja_JP-narrow3.wav",
            "sample-Ja_JP-narrow4.wav",
          ],
          "pt-BR_BroadbandModel": [
            "pt-BR_Sample1-16KHz.wav",
            "pt-BR_Sample2-16KHz.wav",
          ],
        };
        ...
        var playSample = (function () {
          ...
          return function (token, imageTag, iconName, url, callback) {
            ...
            if (currentlyDisplaying && running) {
              showError(
                "Currently another file is playing, please stop the file or wait until it finishes"
              );
              return;
            }
            ...
            xhr.onload = function (e) {
              ...
              reader.onload = function () {
                var contentType =
                  reader.result === "fLaC" ? "audio/flac" : "audio/wav";
        ...
        exports.initPlaySample = function (ctx) {
          (function () {
            ...
            el.click(function (evt) {
              playSample(ctx.token, imageTag, iconName, fileName, function (
                result
              ) {
    ...
    15: [
            ...
            (function () {
              ...
              return function (evt) {
                ...
                if (!running) {
                  ...
                  handleMicrophone(token, currentModel, mic, function (
                    err,
                    socket
                  ) {
                    if (err) {
                  ...
                  console.log(
                    "Stopping microphone, sending stop action message"
                  );
      ...
      { "../Microphone": 1, "../handlemicrophone": 4, "./showerror": 18 },
    ],
    16: [
      function (require, module, exports) {
        var initPlaySample = require("./playsample").initPlaySample;
        ...
        exports.initSelectModel = function (ctx) {
          ...
          function onChooseTargetLanguageClick() {
            ...
            if (currentModel == "en-US_BroadbandModel") {
              list.append(
                "<li role='presentation'><a role='menuitem' tabindex='0'>French</a></li>"
              );
              list.append(
                "<li role='presentation'><a role='menuitem' tabindex='1'>Portuguese</a></li>"
              );
              list.append(
                "<li role='presentation'><a role='menuitem' tabindex='2'>Spanish</a></li>"
              );
              list.append(
                "<li role='presentation'><a role='menuitem' tabindex='3'>Japanese</a></li>"
              ); // activated Japanese model by Taiji
            } else if (currentModel == "ar-AR_BroadbandModel") {
              list.append(
                "<li role='presentation'><a role='menuitem' tabindex='0'>English</a></li>"
              );
          ...
          $("#dropdownMenuList").click(function (evt) {
            ...
            $("#dropdownMenuTargetLanguageDefault").text(
    ...
    17: [
      function (require, module, exports) {
        ...
        exports.initSessionPermissions = function () {
          ...
          // Radio buttons
          var sessionPermissionsRadio = $(
            "#sessionPermissionsRadioGroup input[type='radio']"
          );
